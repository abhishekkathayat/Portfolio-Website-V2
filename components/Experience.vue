<template>
    <div class="mt-10 flex flex-col">
        <div class="w-[750px] h-[250px] bg-cardbgclr px-8 py-4 mb-6"
            ...
            <div class="text-sm mt-4"> Tech Stack: </div>
            <ul class="mt-4 flex">
                <li class="mr-5" v-for="technology in experience.techstack"> 
                    <img :src="technology.imgurl" height="25" width="25" :alt="technology.name"/>
                </li>
            </ul>
        </div>
    </div>
        ...
        this.experiences = [
            {
                from: "01-2022",
                to: "PRESENT",
                designation: "Specialist Programmer • Infosys",
            ...
            },
            {
                from: "06-2019",
                to: "07-2019",
                designation: "Summer Intern • Indian Institute of Remote Sensing (IIRS)",
