<template>
    <div class="lg:hidden text-xs uppercase font-semibold tracking-[2px] mb-6 mx-10"> Projects </div>
    <div class="md:grid md:grid-cols-2 lg:flex lg:flex-wrap mx-10 lg:mx-0">
        <div class="sm:h-[300px] md:h-[350px] lg:w-[225px] lg:h-[480px] xl:w-[285px] xl:h-[420px] 2xl:w-[340px] 2xl:h-[340px] 
                    sm:mb-4 md:odd:mr-3 md:mb-3 lg:odd:mr-2 xl:odd:mr-3 2xl:odd:mr-5 lg:mb-2 xl:mb-3 2xl:mb-5
