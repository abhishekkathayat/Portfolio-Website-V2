    ...
    <div class="flex flex-col mx-6 sm:mx-10 lg:mx-0">
        ...
        <div class="flex flex-col lg:w-fit group">
            <div class="lg:w-[460px] xl:w-[580px] 2xl:w-[700px] flex flex-col p-6 sm:p-8 mb-4 relative bg-center
                ...
                v-for="(article, index) of articles" :key="index" :style="{ 'background-image': `url(${extractThumbnailFromDescription(article.description)})` }">
...
function extractThumbnailFromDescription(description: string): string | null {
    const match = description.match(/<img[^>]+src=["']([^"']+(?:png|jpg|jpeg|webp|gif))["']/i)
